...
import systems.physics.collision.detection.narrowphase.Simplex;
import systems.physics.collision.detection.narrowphase.SupportPoint;
...
public class ContactPointGenerator
{
	 ...
	 * @param b
	 * @param c
	 * @return The barrycentric coordinates of the origin projected onto the closest triangle.
	 */
