package system.rendering.shader;
...
{
	private static final String VERTEX_PATH = "/system/rendering/shaders/vertexShader.glsl";
	private static final String FRAGMENT_PATH = "/system/rendering/shaders/fragmentShader.glsl";
