package ecs.system.rendering.shaders;
...
{
	private static final String VERTEX_PATH = "/ecs/system/rendering/shaders/vertexShader.glsl";
	private static final String FRAGMENT_PATH = "/ecs/system/rendering/shaders/fragmentShader.glsl";
